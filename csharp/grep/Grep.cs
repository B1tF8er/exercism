...
public static class Grep
{
    ...
    private static Flags ParseFlags(string flags) =>
        flags.Split(' ')
    ...
    private static Line CreateLine(string file, int index, string text) =>
        new Line { File = file, Number = index + 1, Text = text };
