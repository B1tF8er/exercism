...
let (==>) (values1, value1) (values2, value2) =
    List.item (index value1 values1) values2 = value2
...
let drinksWater =
    List.item (index Water solution.drinks) solution.nationalities

let ownsZebra =
    List.item (index Zebra solution.pets) solution.nationalities