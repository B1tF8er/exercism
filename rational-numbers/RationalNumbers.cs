...
public struct RationalNumber
{
    ...
    public static RationalNumber operator +(RationalNumber r1, RationalNumber r2) =>
        ReducedRationalNumber(r1.Numerator * r2.Denominator + r1.Denominator * r2.Numerator, r1.Denominator * r2.Denominator);
    ...
    public static RationalNumber operator /(RationalNumber r1, RationalNumber r2) =>
        ReducedRationalNumber(r1.Numerator * r2.Denominator, r1.Denominator * r2.Numerator);

    public RationalNumber Abs() =>
        new RationalNumber(Abs(this.Numerator), Abs(this.Denominator));
    ...
    public double Expreal(int baseNumber) =>
        this.Numerator == 0 ? 1 : Pow(baseNumber);
    ...
    private double Pow(int baseNumber) =>
        NthRoot((Sign(this.Numerator) == Sign(this.Denominator) ?
